...
public class BaseController {
	...
	protected PageInfo getPageInfo(Map<String, Object> paramters) {
		Map<String, Object> object = (Map<String, Object>) paramters.get("pageInfo");
		int pageIndex = (Integer) object.get("pageIndex");
		int pageSize = (Integer) object.get("pageSize");
